 ...
 * 工作／实习经历
 */
public class PersonInternshipActivity extends BaseActivity implements OnClickListener{
	
	PersonInternshipItem mSocialexExperienceItem = new PersonInternshipItem();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_person_internship);
		...
		else if(mtype == 1)
		{
			...
			mSocialexExperienceItem = (PersonInternshipItem)getIntent().getSerializableExtra("item");
			setControlInfo();
		}
	}
	...
	public void onBack(View v) {
		...
		PersonInternshipActivity.this.setResult(RESULT_CANCELED, resultIntent);
	...
	public void onClick(View arg0) {
		...
		case R.id.bn_delete:
		{
			...
			PersonInternshipActivity.this.setResult(RESULT_OK, resultIntent);
			}
			else
			{
				PersonInternshipActivity.this.setResult(RESULT_CANCELED, resultIntent);	
	...
	{
		mSocialexExperienceItem.company= mEt_company.getText().toString();//公司／实验室
	...
	{
		mEt_company.setText(mSocialexExperienceItem.company);//公司／实验室
