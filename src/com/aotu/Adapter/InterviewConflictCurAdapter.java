...
public class InterviewConflictCurAdapter extends BaseAdapter {
	...
	public InterviewConflictCurAdapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater
					.inflate(R.layout.item_interview_details_cur, null);
