...
public class SuangXuanItemAdapter extends BaseAdapter{

	private List<ShuangXuanItem> mData;
	private Context mContext;
	private LayoutInflater mInflater;
	
	
	public SuangXuanItemAdapter(Context context, List<ShuangXuanItem> data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		ShuangXuanItem itemData = mData.get(position);
